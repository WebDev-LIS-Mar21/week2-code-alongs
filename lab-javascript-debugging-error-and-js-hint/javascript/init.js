//Bugs (erros) are introduced by programming 
...
function init() {
  //Error handling
  try { //I'm trying to execute this code
    var result = 0;
    ...
    console.log('An error occurred, try later: ', e);
  } finally {
    //Clean up external connections 
    //Will execute always
    console.log('Good bye, thank you for using our program');
  }
}
